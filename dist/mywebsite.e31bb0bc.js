...
function (_Highway$Transition) {
  ...
  _createClass(Fade, [{
    ...
    value: function _in(_ref) {
      ...
      from.remove(); // new timeline, moves full screen size div across on the x axis

      var tl = new _gsap.TimelineMax({
        onComplete: done
      });
      tl.fromTo(".transition-cover", 1.5, {
        x: "100%",
    ...
    value: function out(_ref2) {
      ...
      var tlOut = new _gsap.TimelineMax({
        onComplete: done
      });
      tlOut.fromTo(".transition-cover", 1.5, {
        x: "0%",
        ease: _gsap.Power4.easeOut
      }, {
        x: "100%",
...
var _default = Fade;
exports.default = _default;
},{"@dogstudio/highway":"node_modules/@dogstudio/highway/build/highway.js","gsap":"node_modules/gsap/index.js"}],"node_modules/scrollmagic/scrollmagic/uncompressed/ScrollMagic.js":[function(require,module,exports) {
var define;
/*!
...
},{"gsap":"node_modules/gsap/index.js","scrollmagic":"node_modules/scrollmagic/scrollmagic/uncompressed/ScrollMagic.js"}],"js/image-animations.js":[function(require,module,exports) {
// import {
// 	TimelineMax
// } from "gsap/TweenMax";
...
// 	// 	.addTo(controller);
// }
},{}],"js/scroll-zoom.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = zoomOutOnScroll;
...
function zoomOutOnScroll(image, text) {
  var scrollHeight = document.documentElement.scrollHeight;
  var scrollPosition = window.innerHeight + window.pageYOffset;
  var distanceFromBottom = scrollHeight - scrollPosition;

  if (distanceFromBottom < 1000) {
    image.style.transform = "translate3d(0px, ".concat(-distanceFromBottom, "px, 0px)");
    image.style.transform = "scale3d(".concat(distanceFromBottom / 1000 + 1, ", ").concat(distanceFromBottom / 1000 + 1, ", 1)");
    text.style.transform = "translate3d(0px, ".concat(distanceFromBottom, "px, 0px)");
  }
}
},{}],"js/custom-renderer.js":[function(require,module,exports) {
"use strict";
...
var _imageAnimations = _interopRequireDefault(require("./image-animations.js"));

var _scrollZoom = _interopRequireDefault(require("./scroll-zoom.js"));
...
function scrollBarHandler() {
  ...
  var nextProjectImage = document.querySelector(".next-project-img");
  var nextProjectText = document.querySelector(".next-project-text");
  (0, _scrollZoom.default)(nextProjectImage, nextProjectText);
}
  ...
  _createClass(CustomRenderer, [{
    ...
    value: function onEnterCompleted() {
      ...
      tlImage.from(".image-cover", 0.5, {
        ...
        scaleX: 0,
        transformOrigin: "right"
      }, "reveal").from(".project-image", 0.1, {
        opacity: 0
      }, "reveal"); // scrolling carousel animation
      ...
      var tlScrolling = new _TweenMax.TimelineMax();
      tlScrolling.from(".scroll-cover", 0.5, {
        scaleX: 0,
        transformOrigin: "left"
      }).to(".scroll-cover", 1, {
        scaleX: 0,
        transformOrigin: "right"
      }, "reveal").from(".scrolling-card", 0.1, {
        opacity: 0
      }, "reveal");
      document.addEventListener("scroll", scrollBarHandler); // positions at which the user has to scroll in order that the GSAP animations occur
      // 1st scene : tlImage tween executed when scrolled to .project-img-container

      new _scrollmagic.default.Scene({
        triggerElement: ".project-img-container",
        reverse: false
      }).setTween(tlImage).addTo(controller); // 2nd scene : tlScrolling tween executed when scrolled to .scrolling-wrapper

      new _scrollmagic.default.Scene({
        triggerElement: ".scrolling-wrapper",
        reverse: false
      }).setTween(tlScrolling).addTo(controller);
    }
  }, {
    key: "onLeave",
    value: function onLeave() {
      // gsap + scrollmagic controller destroy on leaving the page
      _TweenMax.TweenLite.defaultOverwrite = false;
      controller.destroy();
...
exports.default = _default;
},{"@dogstudio/highway":"node_modules/@dogstudio/highway/build/highway.js","gsap/TweenMax":"node_modules/gsap/TweenMax.js","scrollmagic":"node_modules/scrollmagic/scrollmagic/uncompressed/ScrollMagic.js","scrollmagic/scrollmagic/uncompressed/plugins/animation.gsap":"node_modules/scrollmagic/scrollmagic/uncompressed/plugins/animation.gsap.js","./image-animations.js":"js/image-animations.js","./scroll-zoom.js":"js/scroll-zoom.js"}],"js/new-renderer.js":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function (_Highway$Renderer) {
  _inherits(NewRenderer, _Highway$Renderer);

  function NewRenderer() {
    _classCallCheck(this, NewRenderer);

    return _possibleConstructorReturn(this, _getPrototypeOf(NewRenderer).apply(this, arguments));
  }

  _createClass(NewRenderer, [{
    key: "onEnterCompleted",
    value: function onEnterCompleted() {
      // create new scrollmagic controller
      newController = new _scrollmagic.default.Controller(); // image animation
      // 1. black rectanglular div appears from left side
      // 2. once reaches its position, reveals vid behind that has become visible

      var newTlImage = new _TweenMax.TimelineMax();
      ...
      var newTlScrolling = new _TweenMax.TimelineMax();
      ...
      new _scrollmagic.default.Scene({
        triggerElement: ".project-img-container",
        reverse: false
      }).setTween(newTlImage).addTo(newController); // 2nd scene : tlScrolling tween executed when scrolled to .scrolling-wrapper

      new _scrollmagic.default.Scene({
        triggerElement: ".scrolling-wrapper",
        reverse: false
      }).setTween(newTlScrolling).addTo(newController);
    }
  }, {
    key: "onLeave",
    value: function onLeave() {
...
var _default = NewRenderer;
exports.default = _default;
},{"@dogstudio/highway":"node_modules/@dogstudio/highway/build/highway.js","gsap/TweenMax":"node_modules/gsap/TweenMax.js","scrollmagic":"node_modules/scrollmagic/scrollmagic/uncompressed/ScrollMagic.js","scrollmagic/scrollmagic/uncompressed/plugins/animation.gsap":"node_modules/scrollmagic/scrollmagic/uncompressed/plugins/animation.gsap.js","./image-animations.js":"js/image-animations.js","./scroll-zoom.js":"js/scroll-zoom.js"}],"node_modules/quicklink/dist/quicklink.mjs":[function(require,module,exports) {
"use strict";
...
var _fade = _interopRequireDefault(require("./js/fade.js"));

var _customRenderer = _interopRequireDefault(require("./js/custom-renderer.js"));

var _newRenderer = _interopRequireDefault(require("./js/new-renderer.js"));
...
var H = new _highway.default.Core({
  renderers: {
    project: _customRenderer.default,
    snaps: _newRenderer.default,
    mond: _customRenderer.default
  },
  transitions: {
    default: _fade.default
  }
});
},{"@dogstudio/highway":"node_modules/@dogstudio/highway/build/highway.js","./js/fade.js":"js/fade.js","./js/custom-renderer.js":"js/custom-renderer.js","./js/new-renderer.js":"js/new-renderer.js","quicklink/dist/quicklink.mjs":"node_modules/quicklink/dist/quicklink.mjs"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
